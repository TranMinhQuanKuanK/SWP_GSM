 ...
 * @author quan6
 */
@WebServlet(name = "ClearBillServlet", urlPatterns = {"/ClearBillServlet"})
public class ClearBillServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Gson gson = new Gson();
            String billJSONString = gson.toJson(new BillObj());
